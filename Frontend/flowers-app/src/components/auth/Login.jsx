...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError('Autentificare eșuată. Verificați email-ul și parola.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <Card className="card-custom" style={{ width: '450px' }}>
        <Card.Body className="p-4">
          <div className="text-center mb-4">
            <i className="fas fa-spa feature-icon text-primary"></i>
            <h2 className="feature-title mt-3">Autentificare</h2>
          </div>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Button 
              ...
              disabled={loading}
            >
              {loading ? <><i className="fas fa-spinner fa-spin me-2"></i>Se procesează...</> : <><i className="fas fa-sign-in-alt me-2"></i>Autentificare</>}
            </Button>
          </Form>
          ...
          <div className="w-100 text-center mt-4">
            ...
            Nu aveți cont? <Link to="/register" className="text-primary fw-bold">Înregistrați-vă</Link>
          </div>
        </Card.Body>
      </Card>
    </Container>
